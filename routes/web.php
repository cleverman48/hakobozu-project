...
Route::get('/job_app_form/{job_id}', [App\Http\Controllers\HomeController::class, 'jobAppForm'])->name('home.jobAppForm');
...
Route::get('/user_profile/{user_id}/{bid_id}', [App\Http\Controllers\HomeController::class, 'user_profile'])->name('home.user_profile_bid');
...
Route::middleware(['auth','admin'])->group( function(){
    ...
    Route::get('/download-users-csv', [App\Http\Controllers\AdminController::class,'exportCsv'])->name('admin.export.csv');
