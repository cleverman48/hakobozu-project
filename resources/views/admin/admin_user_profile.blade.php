                                ...
                                <div class="table-content  scroll">
                                    <table class="table table-bordered adminInfoTable">
                                        ...
                                        <tr>
                                            <th>ふりがな</th>
                                            <td>
                                                @if (!empty($profile['fullname_kana']))
                                                    <div class="row mame">
                                                        <div class="form-group">
                                                            <label for="">せいめい</label>
                                                            <input type="text" class="form-control" name="fullname_kana"
                                                                value="{{ $profile->fullname_kana }}">
                                                        </div>
                                                    </div>
                                                @else
                                                    <div class="row mame">
                                                        <div class="form-group">
                                                            <label for="">せい</label>
                                                            <input type="text" class="form-control" name="last_name_kana"
                                            ...
                                            <td>
                                                <div class="row inputRadio">
                                                    <label><input type="radio" name="sex" value="1"
                                                            @if ($profile->sex == 1) {{ 'checked' }} @endif>男性</label>
                                                    <label><input type="radio" name="sex" value="0"
                                                            @if ($profile->sex == 0) {{ 'checked' }} @endif>女性</label>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="setZipcode">
                                                    <input type="text" name="zip" id="zip"
                                                        value="{{ $profile->zip }}" data-id="1" placeholder="郵便番号"
                                                        pattern="^[0-9]{7}$" required>
                                                    <button type="button" id="zipSerchButton"
                                                        class="button">郵便番号から入力</button>
                                                ...
                                                <div class="areaSelect">
                                                    <select class="ken_id" name="ken_id" data-id="1" id="ken">
                                                        ...
                                                        @foreach ($prefecture as $v)
                                                            <option value="{{ $v->ken_id }}">{{ $v->ken_name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="row inputRadio">
                                                    <label><input type="checkbox" name="email_receive"
                                                            value="1"@if ($profile->email_receive == 1) {{ 'checked' }} @endif>許可する</label>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
            ...
            $('#ken').change(function() {
                if (this.value) {
                    ...
                    $.getJSON('/api/getCityList/' + ken_id, function(data) {
                        $.each(data, function(index, data2) {
                            $('#city').append($('<option>').text(data2.city_name).val(data2
                                .city_id));
                        });
                    });
                }
