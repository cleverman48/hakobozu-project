...
<div id="mv_low">
    <div class="breadcrumb">
        <ul>
            ...
            @endif
            @isset($search_area)
            <li>&emsp;-&emsp;勤務地検索 : {{ $search_area->area_name }}</li>
            @endif
            @endif
        </ul>
    </div>
            ...
            <li>
                <div class="jobDigest">
                    <div class="jobHead">
                        ...
                        <div class="companyInfo">
                            <p class="logo">
                                <img src="{{ asset('images/jober_profile') }}/{{ $job['company_img'] }}" alt="{{ $job['company_name'] }}">
                            </p>
                ...
                <div class="footer-btn narrow">
                    <div class="buttonArea between">
                        <p class="update">
                            <i class="fa-solid fa-clock-rotate-left" style="color: #0074c1;"></i>
                            &nbsp{{ $job->displayDaysAgo }}
                        </p>
                        @if (Auth::check())
