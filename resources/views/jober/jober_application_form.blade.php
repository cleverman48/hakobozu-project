                    ...
                    <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="fBox first_step1">
                                        ...
                                        <label class="text-title"><input type="checkbox" name="ligt_cargo_experience"
                                                class="radio" value="0" checked>無し</label>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                        ...
                        <tr class="{{Auth::check() ? "":"sp_hidden"}}">
                            ...
                            <td>
                                ...
                                <div id="extend-field">
                                    <div class="flex pb-10 date_select_box">
                        ...
                        <tr class="sp_hidden">
                            <td colspan="2">
                                ...
                                <textarea name="bid_content" class="form-control mt-1" rows="10" placeholder="連絡希望の時間帯やその他伝えたい内容を記入します。"
                                    required></textarea>
                            </td>
                        </tr>
                        <tr class="sp_hidden">
    ...
    <script>
        ...
        $(document).ready(function() {
            const timeCheck = () => {
                ...
                $(".date_select_box input[type='date']").change(function(e) {
                    var selectedDate = new Date($(this).val()).setHours(0, 0, 0, 0);
            ...
            function checkRadios() {
                var isChecked1 = $('.first_step1 input[type="checkbox"]:checked').length > 0;
                var isChecked2 = $('.first_step2 input[type="checkbox"]:checked').length > 0;

                if (isChecked1 && isChecked2 || $('#authcheck').val() == true) {
