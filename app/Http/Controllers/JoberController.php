...
class JoberController extends Controller
{
    ...
    public function index()
    {
        ...
        $jobs = Job::where('jober_id', $jober_id)->whereIn('post_status', [0, 1, 2])->orderBy('post_expired', 'DESC')->paginate(10);
    ...
    {
        $jober_id = $this->get_jober_id();
        $jobs = Job::where('jober_id', $jober_id)->whereIn('post_status', [0, 1, 2])->orderBy('post_expired', 'DESC')->get();
